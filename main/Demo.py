...
user5 = User([],None,None,None)
user5.user_init()

#Adding users and computation of group fingerprint
...
print("Group fingerprint before removing user: ", aliceDevice.groupFingerprint)
print()

aliceDevice.remove_user(dave)
aliceDevice.generate_group_fingerprint()

print("Group fingerprint after removing user: ", aliceDevice.groupFingerprint)
print()

#Verification Stage
Fingerprint.create_scannable_fingerprint(aliceDevice)
bobDevice.qrcode_verification("g1.png")

numericalFingerprint = Fingerprint.create_comparable_fingerprint(aliceDevice.groupFingerprint, bobDevice.groupFingerprint)
print("Numerical Fingerprint Representation: ", numericalFingerprint)
